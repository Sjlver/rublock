...
const DIFFICULTY_THRESHOLDS = {
  ...
  6: [
    ...
    { difficulty: 'medium', minNodes: 1, maxNodes: 1, minWaves: 7, maxWaves: 10 },
    { difficulty: 'challenging', minNodes: 1, maxNodes: 1, minWaves: 11, maxWaves: U32_MAX },
  ...
  7: [
    ...
    { difficulty: 'hard', minNodes: 2, maxNodes: U32_MAX, minWaves: 1, maxWaves: 19 },
    { difficulty: 'very-hard', minNodes: 2, maxNodes: U32_MAX, minWaves: 20, maxWaves: 300 },
    {
      difficulty: 'extremely-hard',
      minNodes: 2,
      maxNodes: U32_MAX,
  ...
  8: [
    { difficulty: 'easy', minNodes: 1, maxNodes: 1, minWaves: 1, maxWaves: 14 },
    { difficulty: 'medium', minNodes: 1, maxNodes: 1, minWaves: 15, maxWaves: 22 },
    { difficulty: 'challenging', minNodes: 1, maxNodes: 1, minWaves: 23, maxWaves: U32_MAX },
    { difficulty: 'hard', minNodes: 2, maxNodes: U32_MAX, minWaves: 1, maxWaves: 200 },
    { difficulty: 'very-hard', minNodes: 2, maxNodes: U32_MAX, minWaves: 201, maxWaves: 6000 },
    {
      difficulty: 'extremely-hard',
      minNodes: 2,
      maxNodes: U32_MAX,
