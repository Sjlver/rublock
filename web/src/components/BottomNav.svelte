        ...
        <div class="nav-btn-pill">
          {#if tab.id === 'play'}
            ...
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
              ...
              <rect x="14.5" y="6" width="3.5" height="3.5" rx="0.6"
                    fill={isActive ? 'currentColor' : 'none'}/>
              <rect x="6" y="14.5" width="3.5" height="3.5" rx="0.6"
                    fill={isActive ? 'currentColor' : 'none'}/>
            </svg>
          ...
          {:else if tab.id === 'howto'}
            ...
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
              ...
              <path d="M9.5 9.2c0-1.3 1.1-2.3 2.5-2.3s2.5 1 2.5 2.3c0 .9-.5 1.5-1.4 2-.8.5-1.1 1-1.1 1.7"/>
